package jw.fluent_api.spigot.gui.button.button_observer.observer_impl;
...
public class ListSelectorObserver<T> implements ButtonNotifier<Integer> {
    ...
    private final Consumer<jw.fluent_api.spigot.gui.button.button_observer.observer_impl.events.onSelectEvent<T>> onSelectEvent;

    public ListSelectorObserver(List<T> values, Function<T, String> mapping) {
        this(values,mapping, (e)->{});
    }

    public ListSelectorObserver(List<T> values, Function<T, String> mapping, Consumer<jw.fluent_api.spigot.gui.button.button_observer.observer_impl.events.onSelectEvent<T>> event) {
