package jw.fluent_api.minecraft.gui.button.button_observer.observer_impl;

import com.google.common.base.Function;
import jw.fluent_api.minecraft.gui.button.ButtonUI;
import jw.fluent_api.minecraft.gui.button.button_observer.ButtonNotifier;
import jw.fluent_api.minecraft.gui.button.button_observer.ButtonObserverEvent;
import jw.fluent_api.minecraft.gui.button.button_observer.observer_impl.events.onSelectEvent;
...
public class ListSelectorObserver<T> implements ButtonNotifier<Integer> {
    ...
    private final Consumer<jw.fluent_api.minecraft.gui.button.button_observer.observer_impl.events.onSelectEvent<T>> onSelectEvent;

    public ListSelectorObserver(List<T> values, Function<T, String> mapping) {
        this(values,mapping, (e)->{});
    }

    public ListSelectorObserver(List<T> values, Function<T, String> mapping, Consumer<jw.fluent_api.minecraft.gui.button.button_observer.observer_impl.events.onSelectEvent<T>> event) {
