package jw.fluent_api.database.mysql.models;

import jw.fluent_api.database.api.database_table.DbTable;
import jw.fluent_api.database.api.query_fluent.select.SelectFluentBridge;
import jw.fluent_api.database.mysql.factories.SqlEntryQueryFactory;
import jw.fluent_api.database.mysql.factories.SqlTableQueryFactory;
import jw.fluent_api.database.mysql.query_fluent.SqlSelect;
...
public class SqlTable<T> implements DbTable<T> {
    ...
    public void createTable()
    {
        ...
        FluentLogger.success(createTableQuery);
