package jw.fluent_api.database.mysql.change_tacker;

import jw.fluent_api.database.api.database_table.change_tracker.ChangeTracker;
import jw.fluent_api.database.mysql.models.SqlEntry;
