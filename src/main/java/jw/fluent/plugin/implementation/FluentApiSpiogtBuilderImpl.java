...
public class FluentApiSpiogtBuilderImpl implements FluentApiSpigotBuilder {
    ...
    @SneakyThrows
    public FluentApiSpiogtBuilderImpl(JavaPlugin plugin) {
        this.plugin = plugin;
        ...
        configFile = new PluginConfigFactory(assemblyScanner, plugin).create(configPath, assemblyScanner);
    }
