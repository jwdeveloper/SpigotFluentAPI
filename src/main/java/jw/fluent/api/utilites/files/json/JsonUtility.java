package jw.fluent.api.utilites.files.json;

import com.google.common.base.Charsets;
import com.google.common.io.CharStreams;
import com.google.gson.*;
import jw.fluent.api.utilites.files.FileUtility;
import jw.fluent.api.utilites.files.json.adapters.DateTimeOffsetAdapter;
import jw.fluent.api.utilites.files.json.adapters.ItemStackAdapter;
import jw.fluent.api.utilites.files.json.adapters.LocationAdapter;
import jw.fluent.api.utilites.files.json.execution.BindingFieldSkip;
import jw.fluent.api.utilites.files.json.execution.JsonIgnoreAnnotationSkip;
...
public final class JsonUtility implements FileUtility {
    public static boolean save(Object data, String path, String fileName) {
        ...
        try (FileWriter file = new FileWriter(fullPath)) {
            ...
            FluentApi.logger().error("Save File: " + fullPath, e);
            e.printStackTrace();
        }
        return false;
    }
    ...
    public static <T> T load(InputStream inputStream, Class<T> type) {
        try {
            ...
            FluentApi.logger().error("Load File: " + type.getSimpleName(), e);
        }
        return null;
    }
    ...
    public static <T> T load(String path, String fileName, Class<T> type) {
        ...
        try (FileReader reader = new FileReader(fullPath)) {
            ...
            FluentApi.logger().error("Load File: " + fullPath, e);
        }
        return null;
    }
