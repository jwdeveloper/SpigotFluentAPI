...
public class SpigotPlayerContainer implements PlayersContainer {
    private final ConcurrentHashMap<UUID, Container> playerContainers;
    private final Container mainContainer;

    public SpigotPlayerContainer(Container container, ConcurrentHashMap<UUID, Container> playerContainers) {
    ...
    public Container clone() {
        ...
        return new SpigotPlayerContainer(mainContainer, clonedContainers);
    }
}
